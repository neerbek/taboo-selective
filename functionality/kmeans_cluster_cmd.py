...
confusion_matrix.write_embeddings("kmeans_embeddingsC1.txt", linesC1)
confusion_matrix.write_embeddings("kmeans_embeddingsC2.txt", linesC2)
confusion_matrix.write_embeddings("kmeans_embeddingsC3.txt", linesC3)
confusion_matrix.write_embeddings("kmeans_embeddings2C1.txt", lines2C1)
confusion_matrix.write_embeddings("kmeans_embeddings2C2.txt", lines2C2)
confusion_matrix.write_embeddings("kmeans_embeddings2C3.txt", lines2C3)

load_trees.put_trees("kmeans_treesC1.txt", [l.tree for l in linesC1])
load_trees.put_trees("kmeans_treesC2.txt", [l.tree for l in linesC2])
load_trees.put_trees("kmeans_treesC3.txt", [l.tree for l in linesC3])
load_trees.put_trees("kmeans_trees2C1.txt", [l.tree for l in lines2C1])
load_trees.put_trees("kmeans_trees2C2.txt", [l.tree for l in lines2C2])
load_trees.put_trees("kmeans_trees2C3.txt", [l.tree for l in lines2C3])
